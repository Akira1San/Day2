...
class SeriesDialog(BaseTagDialog, SeriesProfileMixin):
    ...
    def setup_ui(self):
        ...
        self.repeat_season_spin.setToolTip("0 = all seasons, 1+ = specific season to repeat from")
        ...
        self.random_season_spin.setToolTip("0 = any season, 1+ = specific season for random")
