...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.approx_mode_combo.addItems(["Linear", "Find-Replace", "Early Fill", "Late Fill", "Priority", "Best Fit", "Round Robin", "Linear Spanning", "Exhaustive", "No Overlap", "Group Approximate"])
